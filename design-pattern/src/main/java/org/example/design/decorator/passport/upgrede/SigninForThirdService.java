...
public class SigninForThirdService implements ISigninForThirdService {
    ...
    @Override
    public org.example.design.decorator.passport.old.ResultMsg regist(String username, String password) {
        return service.regist(username,password);
    }

    @Override
    public org.example.design.decorator.passport.old.ResultMsg login(String username, String password) {
