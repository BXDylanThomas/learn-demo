 ...
 *
 * @Author : dylan
 * @Date :create in 2020/5/4 14:46
 */
public class AdvanceCalculater {

	//数字栈
	private Stack<ArithInterpreter> numStack = new Stack<>();
	//操作符stack
	private Stack<String> operatorStack = new Stack<>();

	public AdvanceCalculater(String expression) {
		this.parse(expression);
	}

	private void parse(String expression) {
		//对表达式去除空字符操作
		String formula = this.transformToStand(expression);
	...
	public String transformToStand(String s) {
		String result = "";
